package com.alurachallenge.jdch.principal;

import com.alurachallenge.jdch.model.Autor;
import com.alurachallenge.jdch.model.DatosLibro;
import com.alurachallenge.jdch.model.DatosLibros;
...
import com.alurachallenge.jdch.service.ConsumoAPI;
import com.alurachallenge.jdch.service.ConvertirDatos;
import com.alurachallenge.jdch.utils.IngresarDatos;
import com.alurachallenge.jdch.view.ComunicacionAppUsuario;
...
public class Principal {
    ...
    private void estadisticasLibros(){
       ...
       /* DatosLibros datps = getDatosLibro();
        Libro libro;
        try {
            libro = new Libro(librosTotal.libros());
        } catch (IllegalArgumentException e) {
            System.out.println("Error al crear la serie: " + e.getMessage());
            return;
        }*/
    }
